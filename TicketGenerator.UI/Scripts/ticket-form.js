...
var TicketInfo = function () {
	...
	var submitTicketFormWithSignalR = function () {

		hub = $.connection.ticketHub;
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (data.IsSuccessfulOperation) {
						...
						hub.server.disableBoughtSeats($("#EventId").val(), $("#SectorId").val(), data.SeatId);
	...
	return {
		...
		SubmitTicketFormWithSignalR: submitTicketFormWithSignalR
	};
}();
...
$(document).ready(function () {
	...
	TicketInfo.SubmitTicketFormWithSignalR();
